...
export class Helper {
    ...
    @date 04/12/2019
    **********************************************************************************/
    public EslaPrimeraVez(): boolean {
        const uid = this.firebase.informacionUsuario().uid;
        this.storage.get(uid).then((res: any) => {
            if (uid !== 'si') {
    ...
    ************************************************************************************/
    public testLocalStorage() {
        ...
        this.storage.get('pruebaClave2').then(val => console.log('TLS acceso a la variable pruebaClave2', val));
